...
class WAFW00F(waftoolsengine):
    ...
    def __init__(self, url='www.example.com', debuglevel=0, path='/',
                 followredirect=True, extraheaders={}, proxies=None):

        self.log = logging.getLogger('wafw00f')
        self.attackres = None
        waftoolsengine.__init__(self, url, debuglevel, path, proxies, followredirect, extraheaders)
...
if __name__ == '__main__':
    w = waf_ident_run('www.cdnplanet.com')
    print(w)